...
\begin{exer}[6]
Let \(H\)~be a vector hyperplane in~\(E\) and suppose \(u\in\End(E)\) fixes every element of~\(H\).
\begin{itemize}[itemsep=0pt]
\item There is \(\gamma\in\R\) unique such that for all \(a\in E-H\), \(u(a)\in\gamma a+H\).
